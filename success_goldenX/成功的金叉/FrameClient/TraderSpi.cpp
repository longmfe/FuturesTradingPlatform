...
CTraderSpi::CTraderSpi(TThostFtdcBrokerIDType brokerID,CThostFtdcTraderApi *ppUserapi,TradeApplication *cth)
{
		...
		CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (bIsLast && !IsErrorRspInfo(pRspInfo))
	{
		...
		cerr << "--->>> trader获取当前交易日 = " << pUserApi->GetTradingDay() << endl;
...
{
//	cerr << "--->>> " << "TraderOnRspQryInstrument" << endl;
...
{
	AfxBeginThread(SendInstrumentReplyhreadFunc,this);
}
