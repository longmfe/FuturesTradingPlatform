...
string AccountManage::toString()
{
    string str = "";
    str = "ID:" + Name 
    + split + "YEquity:" + doubleToString(YEquity) 
    + split + "Equity:" + doubleToString(getEquity()) 
    + split + "FloatProfits:" + doubleToString(FloatProfits) 
    + split + "ClosePositonProfits:" + doubleToString(ClosePositonProfits) 
    + split + "Magin:" + doubleToString(Margin) 
    + split + "Fronemargin:" + doubleToString(Fronemargin) 
    + split + "FreeMoney:" + doubleToString(FreeMoney) 
    + split + "FroneComm:" + doubleToString(FroneComm) 
    + split + "Commision:" + doubleToString(Commision);		
    return str;
}
